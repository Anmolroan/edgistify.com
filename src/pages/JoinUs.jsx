  ...
  return (
    <div className="pt-16">
      <Wrapper>
        ...
        <img id='image' src='https://cdn-images-1.medium.com/max/800/1*S-XtAMXJcjbQmlxYhnm2Aw.png' alt='no image' />
        ...
        <form onSubmit={handleSubmit}>
          <div className='maindiv'>
            ...
            <div className='rightdiv'>
              ...
              <input type="file" className="custom-file-input" placeholder='Upload Resume' onChange={(e) => setFile(e.target.files[0])} />
              <p id='p'>*File format PDF only. Maximum file size 2MB.</p>
